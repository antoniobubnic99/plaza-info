...
const BEACH_COLUMNS =
  'id, slug, name_hr, name_en, lat, lng, region, municipality, surface_type, length_m, orientation, description_hr, description_en, izor_point_id, osm_id, amenities, flags, rating_avg, rating_count, sea_assessment';
